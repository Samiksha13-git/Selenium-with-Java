...
public class class1 {
    ...
    l.click();
    Thread.sleep(2000);
    WebElement b=driver.findElement(By.xpath("(//span[@class=\"oxd-text oxd-text--span oxd-main-menu-item--name\"])[12]"));
    b.click();
    Thread.sleep(2000);
    WebElement p=driver.findElement(By.xpath("//textarea[@class=\"oxd-buzz-post-input\"]"));
	p.sendKeys("samiksha");
